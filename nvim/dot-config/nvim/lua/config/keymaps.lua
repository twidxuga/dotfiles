...
-- vim.keymap.set({ "n", "x" }, "<leader>ob", function() require("opencode").ask("@buffer: ", { submit = true }) end, { desc = "Buffer context to opencode" })
...
vim.keymap.set("n", "<leader>oR", function() require("opencode.api").rename_session() end, { desc = "Rename session" })
vim.keymap.set("n", "<leader>op", function() require("opencode.api").configure_provider() end, { desc = "Configure provider" })
vim.keymap.set("n", "<leader>oz", function() require("opencode.api").toggle_zoom() end, { desc = "Toggle zoom" })
vim.keymap.set("n", "<leader>ov", function() require("opencode.api").paste_image() end, { desc = "Paste image" })
vim.keymap.set("n", "<leader>od", function() require("opencode.api").diff_open() end, { desc = "Open diff" })
vim.keymap.set("n", "<leader>o]", function() require("opencode.api").diff_next() end, { desc = "Next diff" })
vim.keymap.set("n", "<leader>o[", function() require("opencode.api").diff_prev() end, { desc = "Prev diff" })
vim.keymap.set("n", "<leader>oc", function() require("opencode.api").diff_close() end, { desc = "Close diff" })
vim.keymap.set("n", "<leader>ox", function() require("opencode.api").swap_position() end, { desc = "Swap position" })
vim.keymap.set({ "n", "x" }, "<leader>o/", function() require("opencode.api").quick_chat() end, { desc = "Quick chat" })
require("which-key").add({ "<leader>or", group = "Revert changes" })
vim.keymap.set("n", "<leader>ora", function() require("opencode.api").diff_revert_all_last_prompt() end, { desc = "Revert all (last prompt)" })
vim.keymap.set("n", "<leader>ort", function() require("opencode.api").diff_revert_this_last_prompt() end, { desc = "Revert this (last prompt)" })
vim.keymap.set("n", "<leader>orA", function() require("opencode.api").diff_revert_all_session() end, { desc = "Revert all (session)" })
